//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=7 LPM_WIDTHB=19 LPM_WIDTHP=26 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_3d01
	...
	wire  w234w;
	wire  [26:0]  w414w;
	wire  [132:0]  w_decoder_node9w;
	wire  [6:0]  w_le_datab_node8w;
	wire  [18:0]  w_lone_sum_node11w;
	wire  [62:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w234w, {w234w, {w234w, {w234w, {w234w, {w226w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, {w234w, w226w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft8a_in = {w234w, {(~ w_sum_node10w[62]), {w_sum_node10w[61], {(~ w_sum_node10w[41]), {w226w, {(~ w_lone_sum_node11w[14]), {(~ w_lone_sum_node11w[13]), {(~ w_lone_sum_node11w[12]), {(~ w_lone_sum_node11w[11]), {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w234w, {w234w, {w234w, {w234w, {(~ w_lone_sum_node11w[15]), {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45:44]}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[18:0]},
		datab_node = {dataa[6:0]},
		final_result_node = {w414w[25:0]},
		result = {final_result_node[25:0]},
		w226w = 1'b1,
		w234w = 1'b0,
		w414w = {wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[18:0]} & {19{w_le_datab_node8w[6]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[5]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[4]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[3]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[2]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[1]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[6:0]},
		w_lone_sum_node11w = {w_decoder_node9w[132:114]},
		w_sum_node10w = {wire_sum_adder1aa_2result[19:0], w_decoder_node9w[76], wire_sum_adder1aa_1result[19:0], w_decoder_node9w[38], wire_sum_adder1aa_0result[19:0], w_decoder_node9w[0]};
endmodule //mult_3d01
//VALID FILE
