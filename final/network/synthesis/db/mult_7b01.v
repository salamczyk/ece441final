//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=7 LPM_WIDTHB=4 LPM_WIDTHP=11 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_7b01
	...
	wire  [9:0]   wire_sft3a_in;
	wire  [9:0]   wire_sft3a_out;
	wire  [9:0]   wire_sft4a_in;
	wire  [9:0]   wire_sft4a_out;
	wire  [9:0]   wire_sft5a_in;
	wire  [9:0]   wire_sft5a_out;
	wire  [9:0]   wire_sft6a_in;
	wire  [9:0]   wire_sft6a_out;
	wire  [6:0]  dataa_node;
	wire  [3:0]  datab_node;
	wire  [10:0]  final_result_node;
	wire  [11:0]  w134w;
	wire  w90w;
	wire  w92w;
	wire  [27:0]  w_decoder_node9w;
	...
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1result_int[8:1];
	assign
	...
	assign
		wire_sft3a_in = {w90w, {(~ w_sum_node10w[17]), {w_sum_node10w[16], {(~ w_sum_node10w[8]), {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w92w, {w92w, {w90w, {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10:9]}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w92w, {w92w, {w92w, {w90w, {w92w, {w92w, {w92w, {w92w, {2{w92w}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		...
		final_result_node = {w134w[10:0]},
		result = {final_result_node[10:0]},
		w134w = {wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w90w = 1'b1,
		w92w = 1'b0,
		w_decoder_node9w = {({dataa_node[6:0]} & {7{w_le_datab_node8w[3]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[2]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[1]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[0]}})},
