...
module  mult_uc01
	...
	wire  [9:0]   wire_sft13a_in;
	wire  [9:0]   wire_sft13a_out;
	wire  [9:0]   wire_sft14a_in;
	wire  [9:0]   wire_sft14a_out;
	wire  [9:0]   wire_sft15a_in;
	wire  [9:0]   wire_sft15a_out;
	wire  [9:0]   wire_sft16a_in;
	wire  [9:0]   wire_sft16a_out;
	...
	assign
		wire_sft10a_in = {w250w, {w250w, {w250w, {w250w, {w250w, {(~ w_sum_node10w[31]), {w232w, {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {(~ w_lone_sum_node11w[0]), {2{w250w}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w250w, {w_sum_node10w[30], {w232w, {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], w232w}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w250w, {w250w, {w_sum_node10w[29], {w250w, {w250w, {w250w, {w250w, {w250w, {w250w, w_sum_node10w[22]}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w250w, {w250w, {w250w, {w250w, {w250w, {w250w, {w250w, {w250w, {2{w250w}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w232w, {wire_sft11a_out[16], {w232w, {w232w, {(~ w_lone_sum_node11w[11]), {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {(~ w_sum_node10w[15]), {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w250w, {w250w, {w_lone_sum_node11w[13], {(~ w_lone_sum_node11w[12]), {w_sum_node10w[61], {w_sum_node10w[60], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17:16]}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w250w, {w250w, {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[33], {w_sum_node10w[32], {2{w250w}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w250w, {(~ w_sum_node10w[63]), {w_sum_node10w[62], {(~ w_sum_node10w[47]), {w232w, {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w250w, {w250w, {w250w, {w250w, {(~ w_lone_sum_node11w[10]), {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35:34]}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[13:0]},
		datab_node = {dataa[8:0]},
		final_result_node = {w444w[22:0]},
		result = {final_result_node[22:0]},
		w232w = 1'b1,
		w250w = 1'b0,
		w444w = {wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		...
		w_lone_sum_node11w = {w_decoder_node9w[125:112]},
