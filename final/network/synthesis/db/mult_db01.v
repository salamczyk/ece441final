//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=8 LPM_WIDTHB=6 LPM_WIDTHP=14 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_db01
	...
	wire	[9:0]	wire_sum_adder1aa_2result_int;
	...
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2result_int[9:1];
	assign
	...
	assign
		wire_sft3a_in = {w126w, {(~ w_sum_node10w[29]), {w_sum_node10w[28], {(~ w_sum_node10w[19]), {w126w, {(~ w_sum_node10w[9]), {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w131w, {w131w, {w126w, {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11:10]}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w131w, {w131w, {w131w, {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {2{w131w}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w131w, {w_sum_node10w[18], w126w}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w131w, {w131w, w_sum_node10w[25]}};
	assign
		dataa_node = {dataa[7:0]},
		datab_node = {datab[5:0]},
		final_result_node = {w194w[13:0]},
		result = {final_result_node[13:0]},
		w126w = 1'b1,
		w131w = 1'b0,
		w194w = {wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
