//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=7 LPM_WIDTHB=7 LPM_WIDTHP=14 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_eb01
	...
	assign
		wire_sft10a_in = {w150w, {w150w, {w150w, {w150w, {w150w, {w142w, {w150w, w142w}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w142w, {wire_sft11a_out[7], {w142w, {w142w, {(~ w_lone_sum_node11w[4]), {w_sum_node10w[16], {(~ w_sum_node10w[8]), {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w150w, {w150w, {w_lone_sum_node11w[6], {(~ w_lone_sum_node11w[5]), {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10:9]}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w150w, {w150w, {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[19], {w_sum_node10w[18], {2{w150w}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w150w, {(~ w_sum_node10w[26]), {w_sum_node10w[25], {(~ w_sum_node10w[17]), {w142w, {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w150w, {w150w, {w150w, {w150w, {(~ w_lone_sum_node11w[3]), {w_sum_node10w[22], {w_sum_node10w[21:20]}}}}}}};
	assign
		dataa_node = {dataa[6:0]},
		datab_node = {datab[6:0]},
		final_result_node = {w234w[13:0]},
		result = {final_result_node[13:0]},
		w142w = 1'b1,
		w150w = 1'b0,
		w234w = {wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[6:0]} & {7{w_le_datab_node8w[6]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[5]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[4]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[3]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[2]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[1]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[6:0]},
		w_lone_sum_node11w = {w_decoder_node9w[48:42]},
