//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=7 LPM_WIDTHB=6 LPM_WIDTHP=13 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=8 cin dataa datab result
//VERSION_BEGIN 20.1 cbx_cycloneii 2020:11:11:17:06:45:SJ cbx_lpm_add_sub 2020:11:11:17:06:45:SJ cbx_mgl 2020:11:11:17:08:38:SJ cbx_nadder 2020:11:11:17:06:46:SJ cbx_stratix 2020:11:11:17:06:46:SJ cbx_stratixii 2020:11:11:17:06:46:SJ  VERSION_END
...
module  mult_bb01
	...
	wire	[8:0]	wire_sum_adder1aa_2result_int;
	wire	wire_sum_adder1aa_2cin;
	wire	[7:0]	wire_sum_adder1aa_2dataa;
	wire	[7:0]	wire_sum_adder1aa_2datab;
	wire	[7:0]	wire_sum_adder1aa_2result;
	wire  [2:0]   wire_sft10a_in;
	wire  [2:0]   wire_sft10a_out;
	wire  [2:0]   wire_sft11a_in;
	wire  [2:0]   wire_sft11a_out;
	wire  [11:0]   wire_sft3a_in;
	wire  [11:0]   wire_sft3a_out;
	wire  [11:0]   wire_sft4a_in;
	wire  [11:0]   wire_sft4a_out;
	wire  [11:0]   wire_sft5a_in;
	wire  [11:0]   wire_sft5a_out;
	wire  [11:0]   wire_sft6a_in;
	wire  [11:0]   wire_sft6a_out;
	...
	wire  [6:0]  dataa_node;
	wire  [5:0]  datab_node;
	wire  [12:0]  final_result_node;
	wire  w122w;
	wire  w127w;
	wire  [13:0]  w186w;
	wire  [41:0]  w_decoder_node9w;
	wire  [5:0]  w_le_datab_node8w;
	wire  [26:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2result_int[8:1];
	assign
		wire_sum_adder1aa_2cin = 1'b1,
		wire_sum_adder1aa_2dataa = {(~ w_decoder_node9w[41]), (~ w_decoder_node9w[41:35])},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[34]}}, w_decoder_node9w[34:29]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft3a_in = {w122w, {(~ w_sum_node10w[26]), {w_sum_node10w[25], {(~ w_sum_node10w[17]), {w122w, {(~ w_sum_node10w[8]), {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w127w, {w127w, {w122w, {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10:9]}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w127w, {w127w, {w127w, {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {2{w127w}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w127w, {w_sum_node10w[16], w122w}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w127w, {w127w, w_sum_node10w[22]}};
	assign
		dataa_node = {dataa[6:0]},
		datab_node = {datab[5:0]},
		final_result_node = {w186w[12:0]},
		result = {final_result_node[12:0]},
		w122w = 1'b1,
		w127w = 1'b0,
		w186w = {wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[6:0]} & {7{w_le_datab_node8w[5]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[4]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[3]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[2]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[1]}}), ({dataa_node[6:0]} & {7{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[5:0]},
		w_sum_node10w = {wire_sum_adder1aa_2result[7:0], w_decoder_node9w[28], wire_sum_adder1aa_1result[7:0], w_decoder_node9w[14], wire_sum_adder1aa_0result[7:0], w_decoder_node9w[0]};
endmodule //mult_bb01
//VALID FILE
